%% AP analysis for EJ's 3-6Hz oscillation paper
% Simultaneous widefield and cortical electrophysiology
% Q: are 3-6Hz oscillations that EJ sees represented in spiking
%
...
% written by Andrew J. Peters, UCL CortexLab
% the data for this analysis can be downloaded from
% https://figshare.com/articles/dataset/ctx_wf_traces_mat/13118435
...
yourDataPath = [];
save_fn = fullfile(yourDataPath,'ctx_wf_traces.mat');
